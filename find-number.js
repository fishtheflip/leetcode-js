...
// Without type convert, but faster and accentable in leetcode
const plusOne = digits => ('' + (BigInt((digits.map((i)=> '' + i)).join('')) + BigInt(1))).split('')

// With type convert
const plusOneVersionTwo = (digits)=> {
    ...
    const digitsArrSumString = ('' + digitsSumNumber).split('')
